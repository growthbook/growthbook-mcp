    ...
    "/visual-changesets/{id}/visual-change/{visualChangeId}": {
        parameters: {
            ...
            path: {
                ...
                visualChangeId: components["parameters"]["visualChangeId"];
            };
            cookie?: never;
        };
        get?: never;
...
export interface components {
    schemas: {
        ...
        Feature: {
            ...
            tags: string[];
            environments: {
                [key: string]: components["schemas"]["FeatureEnvironment"];
            };
        ...
        FeatureRule: components["schemas"]["FeatureForceRule"] | components["schemas"]["FeatureRolloutRule"] | components["schemas"]["FeatureExperimentRule"] | components["schemas"]["FeatureExperimentRefRule"] | components["schemas"]["FeatureSafeRolloutRule"];
        FeatureDefinition: {
            defaultValue: string | number | unknown[] | Record<string, never> | null;
            rules?: {
                force?: string | number | unknown[] | Record<string, never> | null;
                weights?: number[];
                variations?: (string | number | unknown[] | Record<string, never> | null)[];
        ...
        FeatureForceRule: {
             ...
             *     ]
             */
            scheduleRules?: components["schemas"]["ScheduleRule"][];
            id: string;
            enabled: boolean;
            /** @enum {string} */
            type: "force";
        ...
        ExperimentAnalysisSettings: {
            ...
            lookbackOverride?: components["schemas"]["LookbackOverride"];
            /** @enum {unknown} */
            ...
            secondaryMetrics: components["schemas"]["ExperimentMetric"][];
        ...
        ExperimentWithEnhancedStatus: components["schemas"]["Experiment"] & {
            enhancedStatus?: {
                /** @enum {string} */
        ...
        FactTable: {
            ...
            columns?: components["schemas"]["FactTableColumn"][];
...
export interface operations {
    listFeatures: {
        parameters: {
            query?: {
                 ...
                 *     Self-hosted only. Has no effect unless API_ALLOW_SKIP_PAGINATION is set to true or 1.
                 */
                skipPagination?: components["parameters"]["skipPagination"];
            };
            header?: never;
            path?: never;
            cookie?: never;
                ...
                "application/json": {
                    ...
                    environments?: {
                        [key: string]: {
                            ...
                            draft?: {
                                enabled?: boolean;
                                rules: paths["/features"]["post"]["requestBody"]["content"]["application/json"]["schema"]["environments"]["additionalProperties"]["rules"]["items"][];
                                /** @description A JSON stringified [FeatureDefinition](#tag/FeatureDefinition_model) */
                                definition?: string;
                            };
                        };
    ...
    getFeature: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        feature: components["schemas"]["FeatureWithRevisions"];
                    };
                };
            };
        };
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    tags?: string[];
                    environments?: {
                        [key: string]: paths["/features"]["post"]["requestBody"]["content"]["application/json"]["schema"]["environments"]["additionalProperties"];
                    };
                    /** @description Feature IDs. Each feature must evaluate to `true` */
                    prerequisites?: string[];
                    /** @description Use JSON schema to validate the payload of a JSON-type feature value (enterprise only). */
        ...
        requestBody: {
            content: {
                "application/json": {
                    reason?: string;
                    environments: {
                        [key: string]: true | false | "true" | "false" | "1" | "0" | 1 | 0 | "";
                    };
                };
            };
        };
    ...
    getExperiment: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        experiment: components["schemas"]["ExperimentWithEnhancedStatus"];
                    };
                };
            };
        };
    ...
    listVisualChangesets: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        visualChangesets: components["schemas"]["VisualChangeset"][];
                    };
                };
            };
        };
    ...
    getMetricUsage: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        metricUsage: components["schemas"]["MetricUsage"][];
                    };
                };
            };
        };
    ...
    getVisualChangeset: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        visualChangeset: components["schemas"]["VisualChangeset"];
                        experiment?: components["schemas"]["Experiment"];
                    };
                };
            };
    ...
    listSavedGroups: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        savedGroups: components["schemas"]["SavedGroup"][];
                    } & components["schemas"]["PaginationFields"];
                };
            };
        };
    ...
    postSavedGroup: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        savedGroup: components["schemas"]["SavedGroup"];
                    };
                };
            };
        };
    ...
    listMembers: {
        parameters: {
            query?: {
                ...
                /** @description Name of the global role */
                globalRole?: components["parameters"]["globalRole"];
            };
            header?: never;
            path?: never;
            cookie?: never;
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    toggleOnList?: Record<string, never>;
                    /** @description Default state for new features */
                    defaultState?: Record<string, never>;
                    projects?: string[];
    ...
    listFactTables: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factTables: components["schemas"]["FactTable"][];
                    } & components["schemas"]["PaginationFields"];
                };
            };
        };
    ...
    postFactTable: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factTable: components["schemas"]["FactTable"];
                    };
                };
            };
        };
    ...
    listFactTableFilters: {
        parameters: {
            ...
            path: {
                /** @description Specify a specific fact table */
                factTableId: components["parameters"]["factTableId"];
            };
            cookie?: never;
        };
        requestBody?: never;
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factTableFilters: components["schemas"]["FactTableFilter"][];
                    } & components["schemas"]["PaginationFields"];
                };
            };
        };
    ...
    postFactTableFilter: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factTableFilter: components["schemas"]["FactTableFilter"];
                    };
                };
            };
        };
    ...
    listFactMetrics: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factMetrics: components["schemas"]["FactMetric"][];
                    } & components["schemas"]["PaginationFields"];
                };
            };
        };
    ...
    postFactMetric: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        factMetric: components["schemas"]["FactMetric"];
                    };
                };
            };
        };
    ...
    postFactMetricAnalysis: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        metricAnalysis: components["schemas"]["MetricAnalysis"];
                    };
                };
            };
        };
        ...
        requestBody: {
            content: {
                "application/json": {
                    factTables?: {
                        id: string;
                        data: paths["/fact-tables"]["post"]["requestBody"]["content"]["application/json"]["schema"];
                    }[];
                    factTableFilters?: {
                        factTableId: string;
                        id: string;
                        data: paths["/fact-tables/{factTableId}/filters"]["post"]["requestBody"]["content"]["application/json"]["schema"];
                    }[];
                    factMetrics?: {
                        id: string;
                        data: paths["/fact-metrics"]["post"]["requestBody"]["content"]["application/json"]["schema"];
                    }[];
                };
            };
        };
    ...
    listCodeRefs: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        codeRefs: components["schemas"]["CodeRef"][];
                    } & components["schemas"]["PaginationFields"];
                };
            };
        };
